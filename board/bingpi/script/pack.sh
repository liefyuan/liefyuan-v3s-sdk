...
_UBOOT_FILE="${temp_root_dir}/u-boot-sunxi-with-spl.bin"
_SPLASH_BMP_FILE="${temp_root_dir}/bootlogo.bmp"
_BOOT_SCR_FILE="${temp_root_dir}/boot.scr"
_KERNEL_IMAGE_FILE="${temp_root_dir}/zImage"
_DTB_FILE="${temp_root_dir}/sun8i-v3s-licheepi-zero-dock.dtb"
_ROOTFS_TGZ_FILE="${temp_root_dir}/rootfs.tar"
